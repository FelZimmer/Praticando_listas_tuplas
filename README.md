...
- Manipulação e organização de listas
- Uso de tuplas para agrupar e proteger dados
- Ordenação e reorganização de elementos
...
- `Ordenando_eventos.py`
- `Organizando_notas.py`
- `Registrand_dados_de_alunos.py`
- `Registrando_voluntarios.py`
- `Removendo_ultimo_pedido.py`
- `Reorganizando_lista_convidados.py`
